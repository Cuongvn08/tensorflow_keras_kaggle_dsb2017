...
subset = 'subset0/'
output_path = "../data/output/" + subset
...
def get_file_path(file_path_list, file_name):
    '''
    get file path in path list
    '''
...
df_node["file"] = df_node["seriesuid"].map(lambda file_name:
                                           get_file_path(file_path_list, file_name))
df_node = df_node.dropna()

# get images & masks
for fcount, img_file in enumerate(tqdm(file_path_list)):
    # debug
    print(fcount)
    print(img_file)
